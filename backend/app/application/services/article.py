...
class ArticleService:
    ...
    async def create_article(
            self, title: str, content: str, author_id: int) -> ArticleDTO:
    ...
    async def update_article(self, author_id: int,article_id: int, 
                             title: str, content: str) -> ArticleDTO:
    ...
    async def delete_article(
            self, author_id: int,article_id: int):
        await self.article_repository.delete(
            author_id, article_id)

    async def get_articles(
            self, author_id: int | None = None) -> List[ArticleDTO]:
